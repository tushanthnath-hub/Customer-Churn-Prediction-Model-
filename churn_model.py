...
def preprocess(df: pd.DataFrame):
    ...
    # Handle missing values - Removed from here, moved to main function
...
def main():
    ...
    # Handle missing values in df_raw before feature engineering
    print("\n[Fix] Handling missing values in raw data\u2026")
...
if __name__ == "__main__":
    main()    age             = rng.integers(18, 70, n_samples)
